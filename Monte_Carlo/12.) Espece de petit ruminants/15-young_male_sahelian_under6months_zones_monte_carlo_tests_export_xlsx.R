# Young male Sahelian count under 6 months vs vegetation and phytogeographic zones
# Inputs: data7.xlsx and zones.xlsx
# Output: young_male_sahelian_under6months_zones_monte_carlo_results.xlsx
...
OUTPUT_FILE <- "young_male_sahelian_under6months_zones_monte_carlo_results.xlsx"
COUNT_COL <- "12.) Effectif et composition du cheptel/Nbre de petits (< 6 mois) mâle_Sahelien"
...
COUNT_COL <- resolve_column(
  COUNT_COL, names(raw),
  c("Effectif et composition du cheptel", "Nbre de petits", "6 mois", "male", "Sahelian"),
  "Young male Sahelian count under 6 months"
)
...
veg <- run_monte_carlo(
  "vegetation_zone",
  "Young male Sahelian count under 6 months x vegetation zone",
  0L
)
phyto <- run_monte_carlo(
  "phytogeo_zone",
  "Young male Sahelian count under 6 months x phytogeographic zone",
  100L
)
